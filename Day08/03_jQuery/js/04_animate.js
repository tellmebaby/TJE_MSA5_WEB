...
$(function() {
    ...
    */
    ...
    /* 
       ...
       : backgroundPositionX, backgroundPositionY, borderBottomWidth
       , borderLeftWidth, borderRightWidth, borderSpacing, borderTopWidth
       , borderWidth, bottom, fontSize, height, left, letterSpacing, lineHeight
       , margin, marginBottom, marginLeft, marginRight, marginTop, maxHeight
       , maxWidth, minHeight, minWidth, opacity, outlineWidth, padding, paddingBottom
       , paddingLeft, paddingRight, paddingTop, right, textIndent, top, width, wordSpacing
    */
       ...
       $('.active').on('click', function() {
            ...
            if( flag ) {
                $('#box5').stop().addClass('active')
            }
            else {
                $('#box5').stop().addClass('reset')
            }
            flag = !flag
       })
       // addClass()        : 클래스 속성 추가
